...
##Research question 1: Research question 1 : P(good health | cardio and strength)
...
#Research question 1 : P(good health | cardio and strength) 
...
```{r}
## put exercise frequencies into categories 
...
##ggplot(m, aes(x=factor(cluster), y=exerhmm1)) + geom_boxplot()
...
##Research quesion 3: What is the relationship between exercise, sleep time and health status?
