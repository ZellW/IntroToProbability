...
We learned above BRFSS attempts to use random sampling technoques to remove bias from the surveys.  If true, then the results of the surveys should be gernerailzable to the populations.  If generalizable, results suggest causation.
